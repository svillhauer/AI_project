...
# IMPORTS
###############################################################################
from tensorflow.keras.layers import Input, BatchNormalization, concatenate, Dense, Flatten
...
###############################################################################
    def create(self,
        ...
        inputShape = featureExtractorModel.input_shape[1:]
    ...
    def fit(self, *args, **kwargs):
        # Ensure the underlying Keras model's fit method returns the history
        return self.theModel.fit(*args, **kwargs)

    ###############################################################################
    # WRAP THE EVALUATE FUNCTION
    ###############################################################################
    def evaluate(self, *args, **kwargs):
        return self.theModel.evaluate(*args, **kwargs)

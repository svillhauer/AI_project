...
# CREATES THE MODEL
###############################################################################
    def create(self,inputShape=(64,64,3),theFilters=[16,16,16]): # Changed from 16,16,32
        ...
        decoderInput = Input(shape=encoderOutput.shape[1:], name='decoder_input')
        ...
        #self.encoderModel.compile(optimizer='adam', loss='mse', metrics=['accuracy','mse','mae'])
        self.theModel.compile(optimizer='adam', loss='mean_squared_error', metrics=['accuracy','mean_squared_error', 'mae'])
        self.decoderModel.compile(optimizer='adam', loss='mean_squared_error', metrics=['accuracy','mean_squared_error', 'mae'])
        self.encoderModel.compile(optimizer='adam', loss='mean_squared_error', metrics=['accuracy','mean_squared_error', 'mae'])
